...
{
    public partial class SPORTSADDSTOCK : Form
    {
        ...
        public SPORTSADDSTOCK(string id, int quantity)
        {
            InitializeComponent();
        ...
        private void rjButton22_Click(object sender, EventArgs e)
        {
            ...
            string currentQuantityQuery = "SELECT QUANTITY FROM SPORTS WHERE ID = @ID";
            ...
            string query = "UPDATE SPORTS SET QUANTITY = QUANTITY + @QUANTITY, DATE2 = @DATE2 WHERE ID = @ID";
            ...
            if (result > 0)
            {
                ...
                SPORTSUPDATE updateForm = Application.OpenForms.OfType<SPORTSUPDATE>().FirstOrDefault();
                if (updateForm != null)
                {
        ...
        private void SPORTSADDSTOCK_Load(object sender, EventArgs e)
        {
