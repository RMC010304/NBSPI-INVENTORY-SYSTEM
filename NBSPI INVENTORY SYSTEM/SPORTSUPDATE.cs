...
namespace NBSPI_INVENTORY_SYSTEM
{
    public partial class SPORTSUPDATE : Form
    {
        ...
        SPORTS hm;
        public SPORTSUPDATE(SPORTS control,string item, string id, string brand, string model, string category, string date, int quantity)
        {
            InitializeComponent();
        ...
        private void rjButton22_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE SPORTS SET ITEM=@ITEM, BRAND=@BRAND, MODEL=@MODEL, CATEGORY=@CATEGORY, DATE2=@DATE2 WHERE ID =@ID";
