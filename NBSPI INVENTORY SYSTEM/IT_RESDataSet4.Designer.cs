...
namespace NBSPI_INVENTORY_SYSTEM {
    ...
    public partial class IT_RESDataSet4 : global::System.Data.DataSet {
        ...
        public partial class ITEMSDataTable : global::System.Data.TypedTableBase<ITEMSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ITEMSRow AddITEMSRow(string ITEM, string BRAND, string MODEL, string CATEGORY, int QUANTITY, string STATUS, System.DateTime DATE, System.DateTime DATE2) {
...
namespace NBSPI_INVENTORY_SYSTEM.IT_RESDataSet4TableAdapters {
    ...
    public partial class ITEMSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ITEMS] ([ITEM], [BRAND], [MODEL], [CATEGORY], [QUANTITY], [STATUS], [DATE], [DATE2]) VALUES (@ITEM, @BRAND, @MODEL, @CATEGORY, @QUANTITY, @STATUS, @DATE, @DATE2);
SELECT ID, ITEM, BRAND, MODEL, CATEGORY, QUANTITY, STATUS, DATE, DATE2 FROM ITEMS WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ITEMS] SET [ITEM] = @ITEM, [BRAND] = @BRAND, [MODEL] = @MODEL, [CATEGORY] = @CATEGORY, [QUANTITY] = @QUANTITY, [STATUS] = @STATUS, [DATE] = @DATE, [DATE2] = @DATE2 WHERE (([ID] = @Original_ID) AND ((@IsNull_ITEM = 1 AND [ITEM] IS NULL) OR ([ITEM] = @Original_ITEM)) AND ((@IsNull_BRAND = 1 AND [BRAND] IS NULL) OR ([BRAND] = @Original_BRAND)) AND ((@IsNull_MODEL = 1 AND [MODEL] IS NULL) OR ([MODEL] = @Original_MODEL)) AND ((@IsNull_CATEGORY = 1 AND [CATEGORY] IS NULL) OR ([CATEGORY] = @Original_CATEGORY)) AND ((@IsNull_QUANTITY = 1 AND [QUANTITY] IS NULL) OR ([QUANTITY] = @Original_QUANTITY)) AND ((@IsNull_STATUS = 1 AND [STATUS] IS NULL) OR ([STATUS] = @Original_STATUS)) AND ((@IsNull_DATE = 1 AND [DATE] IS NULL) OR ([DATE] = @Original_DATE)) AND ((@IsNull_DATE2 = 1 AND [DATE2] IS NULL) OR ([DATE2] = @Original_DATE2)));
SELECT ID, ITEM, BRAND, MODEL, CATEGORY, QUANTITY, STATUS, DATE, DATE2 FROM ITEMS WHERE (ID = @ID)";
        ...
        public virtual int Fill(IT_RESDataSet4.ITEMSDataTable dataTable) {
        ...
        public virtual IT_RESDataSet4.ITEMSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IT_RESDataSet4.ITEMSDataTable dataTable = new IT_RESDataSet4.ITEMSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IT_RESDataSet4.ITEMSDataTable dataTable) {
