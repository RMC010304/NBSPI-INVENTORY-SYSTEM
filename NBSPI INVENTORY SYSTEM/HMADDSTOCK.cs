...
{
    public partial class HMADDSTOCK : Form
    {
        ...
        public HMADDSTOCK(string id, int quantity)
        {
            InitializeComponent();
        ...
        private void rjButton22_Click(object sender, EventArgs e)
        {
            ...
            string currentQuantityQuery = "SELECT QUANTITY FROM IT WHERE ID = @ID";
            ...
            string query = "UPDATE IT SET QUANTITY = QUANTITY + @QUANTITY, DATE2 = @DATE2 WHERE ID = @ID";
        ...
        private void HMADDSTOCK_Load(object sender, EventArgs e)
        {
