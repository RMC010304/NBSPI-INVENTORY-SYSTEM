...
namespace NBSPI_INVENTORY_SYSTEM
{
    public partial class SCIENCE : UserControl
    {
        ...
        {
            SCIENCEADD iTADD = new SCIENCEADD(this, "", 0, "", "", "");
            iTADD.Show();
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.SCIENCE WHERE DATE BETWEEN @date1-1 AND @date2", con);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.SCIENCE WHERE DATE2 BETWEEN @date1-1 AND @date2", con);
        ...
        private void rjTextBox1__TextChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=localhost;Initial Catalog=IT_RES;User ID=sa;Password=12345678"))
            {
                ...
                string query = @"SELECT * FROM dbo.SCIENCE  WHERE CONCAT(ID, ITEM, BRAND, MODEL, CATEGORY, QUANTITY) LIKE @searchText";
        ...
        public void GetItems2()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.SCIENCE", con))
            {
                con.Open();
                SqlDataReader sdr = cmd.ExecuteReader();
                dt.Load(sdr);
        ...
        private void rjButton3_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "SCIENCE LABORATORY";
        ...
        private void dataGridView5_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView5.Columns[e.ColumnIndex].HeaderText == "  ")
            {
                ...
                SCIENCEDELETE deleteForm = new SCIENCEDELETE(this, itemId);
            ...
            if (dataGridView5.Columns[e.ColumnIndex].HeaderText == " ")
            {
                ...
                SCIENCEUPDATE iTUPDATE = new SCIENCEUPDATE(this,item, id, brand, model, category, date, quantity);
                iTUPDATE.Show();
