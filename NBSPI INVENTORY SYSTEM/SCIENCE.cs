...
namespace NBSPI_INVENTORY_SYSTEM
{
    public partial class SCIENCE : UserControl
    {
        ...
        public void GetItems()
        {
            ...
            SqlConnection con = new SqlConnection(@"Data Source=localhost;Initial Catalog=IT_RES;Integrated Security=True");
            SqlCommand cmd = new SqlCommand($"SELECT * FROM dbo.SCIENCE ORDER BY DATE {orderBy}", con);
        ...
        {
            SCIENCEADD iTADD = new SCIENCEADD(this, "", 0, "", "", "", "", null);
            iTADD.Show();
        }
        ...
        public void GetItems2()
        {
            ...
            using (SqlCommand cmd = new SqlCommand($"SELECT * FROM dbo.SCIENCE ORDER BY DATE {orderBy}", con))
            {
                con.Open();
                SqlDataReader sdr = cmd.ExecuteReader();
                dt.Load(sdr);
        ...
        private void dataGridView5_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView5.Columns[e.ColumnIndex].HeaderText == " ")
            {
                ...
                SCIENCEUPDATE iTUPDATE = new SCIENCEUPDATE(this,item, id, brand, model, category, date, quantity, description, photo);
                iTUPDATE.Show();
