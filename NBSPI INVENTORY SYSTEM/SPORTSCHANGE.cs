...
{
    public partial class SPORTSCHANGE : Form
    {
        ...
        public SPORTSCHANGE(string id, int quantity)
        {
            InitializeComponent();
        ...
        private void rjButton22_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE SPORTS SET QUANTITY=@QUANTITY,DATE2=@DATE2 WHERE ID =@ID";
        ...
        private void SPORTSCHANGE_Load(object sender, EventArgs e)
        {
