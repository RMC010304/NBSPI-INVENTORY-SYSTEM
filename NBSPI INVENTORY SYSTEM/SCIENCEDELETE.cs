    ...
    public partial class SCIENCEDELETE : Form
    {
        ...
        private void rjButton22_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(conn))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("DELETE FROM SCIENCE WHERE ID = @ID", con))
                {
