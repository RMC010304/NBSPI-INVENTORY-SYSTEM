...
namespace NBSPI_INVENTORY_SYSTEM
{
    ...
    {
        public BORROWDETAILS(string label1Text, int label2Text, string label3Text, string label12Text, string label13Text,
                             string label14Text, string label15Text, string label4Text, string label5Text, DateTime label6Text, DateTime label7Text, Color statusColor, string label8Text, byte[] photoData)
        {
            InitializeComponent();
